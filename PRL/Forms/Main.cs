...
public partial class Main : Form
{
    ...
    private List<SinhvienVM> _listSV = new();
    private readonly SinhvienServices _sinhvienServices = new();
    ...
    private void LoadGrid(string searchText, string searchType)
    {
        ...
        {
            var stt = _listSV.IndexOf(sv) + 1;

            dataGridView1.Rows.Add(stt, sv.Sinhvien.Ten, sv.Sinhvien.Email, sv.Sinhvien.Sdt, sv.Sinhvien.Diachi,
                sv.TenPH, sv.NgheNghiepPH);
        }
    }
    ...
    private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
    {
        ...
        if (index < 0 || index >= _listSV.Count) return;
